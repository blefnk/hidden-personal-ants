...
- **🚀 Live Demo**: [hidden-personal-ants.vercel.app](https://hidden-personal-ants.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/hidden-personal-ants)
...
1. `git clone https://github.com/blefnk/hidden-personal-ants.git`
2. `cd hidden-personal-ants`
3. `bun i`
